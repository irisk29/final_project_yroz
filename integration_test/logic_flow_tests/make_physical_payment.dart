...
void main() {
  ...
  group('make physical payment', () {
    ...
    test(
        'make payment - bad scenario: using cashback when the user does not have any',
        () async {
      var res = await UsersStorageProxy()
          .createUser("flowtest@gmail.com", "test flow", "https://pic.png");
      UserAuthenticator().setCurrentUserId("flowtest@gmail.com");
      ...
      var makePaymentRes =
          await user1.makePaymentPhysicalStore(card, 20, 100, physicalStoreID);
    ...
    test(
      ...
      //no such credit card
      var makePaymentRes =
          await user1.makePaymentPhysicalStore("12", 20, 100, physicalStoreID);
      expect(makePaymentRes.getTag(), false);
