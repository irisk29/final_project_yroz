...
class StoreProductModel extends Model {
  ...
  const StoreProductModel._internal(
      {required this.id,
      required name,
      required categories,
      required price,
      ...
      : _name = name,
        ...
        _onlinestoremodelID = onlinestoremodelID,
  ...
  factory StoreProductModel(
      ...
      String? imageUrl,
      String? description,
      required String onlinestoremodelID}) {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'onlinestoremodelID': _onlinestoremodelID,
