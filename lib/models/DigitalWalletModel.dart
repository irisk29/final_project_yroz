...
class DigitalWalletModel extends Model {
  ...
  const DigitalWalletModel._internal({@required this.id, this.cashBackAmount});

  factory DigitalWalletModel({String id, double cashBackAmount}) {
  ...
  String toString() {
    ...
    buffer.write("cashBackAmount=" +
        (cashBackAmount != null ? cashBackAmount.toString() : "null"));
    buffer.write("}");
  ...
  Map<String, dynamic> toJson() => {'id': id, 'cashBackAmount': cashBackAmount};
