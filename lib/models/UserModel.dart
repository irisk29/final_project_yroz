...
class UserModel extends Model {
  ...
  const UserModel._internal(
      ...
      shoppingBagModels,
      favoriteStores,
      required hideStoreOwnerOptions,
      required isLoggedIn,
      createdAt,
      updatedAt,
      ...
      : _email = email,
        ...
        _eWallet = eWallet,
        _storeOwnerModel = storeOwnerModel,
        _shoppingBagModels = shoppingBagModels,
        _favoriteStores = favoriteStores,
        _hideStoreOwnerOptions = hideStoreOwnerOptions,
        _isLoggedIn = isLoggedIn,
        _createdAt = createdAt,
        _updatedAt = updatedAt,
        _userModelStoreOwnerModelId = userModelStoreOwnerModelId;
  ...
  factory UserModel(
      ...
      String? favoriteStores,
      required bool hideStoreOwnerOptions,
  ...
  bool operator ==(Object other) {
    ...
    return other is UserModel &&
        ...
        DeepCollectionEquality()
            .equals(_shoppingBagModels, other._shoppingBagModels) &&
  ...
  String toString() {
    ...
    buffer.write("hideStoreOwnerOptions=" +
        (_hideStoreOwnerOptions != null
            ? _hideStoreOwnerOptions!.toString()
            : "null") +
        ", ");
    buffer.write("isLoggedIn=" +
        (_isLoggedIn != null ? _isLoggedIn!.toString() : "null") +
        ", ");
    ...
    buffer.write("updatedAt=" +
        ...
        ", ");
    buffer
        .write("userModelStoreOwnerModelId=" + "$_userModelStoreOwnerModelId");
    buffer.write("}");
  ...
  UserModel copyWith(
    ...
    return UserModel._internal(
        ...
        hideStoreOwnerOptions:
            hideStoreOwnerOptions ?? this.hideStoreOwnerOptions,
  ...
  UserModel.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _storeOwnerModel = json['storeOwnerModel']?['serializedData'] != null
            ? StoreOwnerModel.fromJson(new Map<String, dynamic>.from(
                json['storeOwnerModel']['serializedData']))
            : null,
        _shoppingBagModels = json['shoppingBagModels'] is List
            ? (json['shoppingBagModels'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => ShoppingBagModel.fromJson(
  ...
  Map<String, dynamic> toJson() => {
        ...
        'eWallet': _eWallet,
        'storeOwnerModel': _storeOwnerModel?.toJson(),
        'shoppingBagModels': _shoppingBagModels
            ?.map((ShoppingBagModel? e) => e?.toJson())
            .toList(),
        'favoriteStores': _favoriteStores,
        'hideStoreOwnerOptions': _hideStoreOwnerOptions,
        'isLoggedIn': _isLoggedIn,
        'createdAt': _createdAt?.format(),
        'updatedAt': _updatedAt?.format(),
        'userModelStoreOwnerModelId': _userModelStoreOwnerModelId
      };
  ...
  static final QueryField FAVORITESTORES =
      QueryField(fieldName: "favoriteStores");
  static final QueryField HIDESTOREOWNEROPTIONS =
      QueryField(fieldName: "hideStoreOwnerOptions");
