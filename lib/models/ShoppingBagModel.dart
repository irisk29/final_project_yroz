...
class ShoppingBagModel extends Model {
  ...
  const ShoppingBagModel._internal(
      {required this.id,
      required usermodelID,
      CartProductModels,
      onlineStoreID,
      createdAt,
      updatedAt})
      : _usermodelID = usermodelID,
        _CartProductModels = CartProductModels,
        _onlineStoreID = onlineStoreID,
  ...
  factory ShoppingBagModel(
    ...
    return ShoppingBagModel._internal(
        ...
        CartProductModels: CartProductModels != null
            ? List<CartProductModel>.unmodifiable(CartProductModels)
            : CartProductModels,
  ...
  bool operator ==(Object other) {
    ...
    return other is ShoppingBagModel &&
        ...
        DeepCollectionEquality()
            .equals(_CartProductModels, other._CartProductModels) &&
      ...
      : id = json['id'],
        ...
        _CartProductModels = json['CartProductModels'] is List
            ? (json['CartProductModels'] as List)
                ...
                .map((e) => CartProductModel.fromJson(
  ...
  Map<String, dynamic> toJson() => {
        ...
        'CartProductModels':
            _CartProductModels?.map((CartProductModel? e) => e?.toJson())
                .toList(),
  ...
  static final QueryField ONLINESTOREID =
      QueryField(fieldName: "onlineStoreID");
  static var schema =
