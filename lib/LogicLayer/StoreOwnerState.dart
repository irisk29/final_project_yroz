...
class StoreOwnerState {
  ...
  DateTime lastTimeViewedPurchases =
      DateFormat('yyyy/MM/dd hh:mm:ss').parse('2022/1/1 10:00:00');
  ...
  bool hasOnlineStore(String storeId) {
    return this.onlineStore != null && this.onlineStore!.id == storeId;
  }

  bool hasPhysicalStore(String storeId) {
    return this.physicalStore != null && this.physicalStore!.id == storeId;
  }
