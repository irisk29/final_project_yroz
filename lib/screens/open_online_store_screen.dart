...
class _OpenOnlineStorePipelineState extends State<OpenOnlineStorePipeline> {
  ...
  void initState() {
    _formChanged = false;
    openingHours = OpeningHours(OpenOnlineStorePipeline.openings.clone(), () => _formChanged = true);
    super.initState();
  }
    ...
    switch (_currentStep) {
      ...
      case 5:
        return SizedBox(
          ...
          child: Column(
            children: [
              StorePreview(true, _editedStore!.name, _editedStore!.address, _pickedImage, null,
